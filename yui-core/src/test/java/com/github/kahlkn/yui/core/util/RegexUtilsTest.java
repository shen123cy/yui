...
public class RegexUtilsTest {
    ...
    public void test5() throws Exception {
        List<String> list = RegexUtils.findAllALabel(HttpUtils.create("http://uux.me").get());
        for (String s : list) {
    ...
    public void test6() throws Exception {
        List<String> list = RegexUtils.findAllImgLabel(HttpUtils.create("http://uux.me/2").get());
        for (String s : list) {
            System.out.println(s);
        }
    }
